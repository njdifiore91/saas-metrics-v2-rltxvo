...
- **Pipeline Coverage Trends** (Line Chart) – Tracks pipeline coverage ratios over time.
...
- **Color Palette**: Deep Navy (#151e2d), Ocean Blue (#46608C), Forest Green (#168947), Sage Green (#DBEAAC), Deep Teal (#0D3330)
